module.exports = {
  ...
  execute: async function(oldMessage, newMessage, client) {
    try {
      ...
      if (message.content && message.content.length > 1024) message.content = message.content.substring(0, 1020) + '...';
      if (oldMessage.content && oldMessage.content.length > 1024) oldMessage.content = oldMessage.content.substring(0, 1020) + '...';
