module.exports = {
    name: 'meme',
    description: "",
    execute(message, args, Discord, client, prefix, fs, db, command) {
      try {
...
client.api.applications(client.user.id).guilds('711249925349965864').commands.post({data: {
    "name": "meme",
    "description": "Invia un fantastico meme!",
    "options": []
}})